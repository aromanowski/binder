# Original source: [Binder / Alan-Turing-Institute](https://github.com/alan-turing-institute/the-turing-way/edit/master/workshops/boost-research-reproducibility-binder/workshop-presentations/zero-to-binder-python.md)
